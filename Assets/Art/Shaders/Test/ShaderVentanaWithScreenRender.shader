        ...
        SubShader
        {
            ...
            Pass
            {
                ...
                v2f vert(appdata v)
                {
                    ...
                    o.posPantalla = ComputeScreenPos(o.vertex); //Muestra la textura según el espacio de la pantalla
                    o.uv = TRANSFORM_TEX(v.vertex.xy, _MainTex); //Usa coordenadas UV básicas 
                ...
                float3 Layer(float2 UV, float t)
                {
                    ...
                    float n = N21(id); //da un número random entre 0 y 1
                    t += n * 6.2831;
                    ...
                    y -= (gv.x - x) * (gv.x - x); //para cambiar la forma del círculo
